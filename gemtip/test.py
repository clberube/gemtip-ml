...
EM_conduc = instance.return_conduc_rot(
    depols[0], depols[1], fl, sl, c_exp_l, alphal, s0, w
).to("cpu")
f_cpu = f.to("cpu")
...
EM_conduc_anis = instance.return_conduc_rot(
    depols_anis[0], depols_anis[1], fl, sl, c_exp_l, alphal, s0, w
).to("cpu")
